...
export function TextareaWidget(props: WidgetProps) {
  ...
  return (
    <textarea
      ...
      onFocus={(e) => onFocus(id, e.target.value)}
      rows={4}
      className="placeholder:text-text-muted border-border bg-surface text-text w-full min-w-0 rounded-md border px-3 py-2 text-base outline-none transition-colors focus-visible:border-primary focus-visible:ring-primary-light focus-visible:ring-2 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 resize-none"
    />
  );
}
